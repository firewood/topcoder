...
//		LL Max = max((LL)a*b, (LL)c);
//		int Max = max(max(a,b),c)*2;
		int Max = c*2;
		int result = INF;
		int i, j;
		for (i = 1; i<a+c; ++i) {
...
//	void test_case_0() { int Arg0 = 1000000; int Arg1 = 1000000; int Arg2 = 1; int Arg3 = 1999998; verify_case(0, Arg3, getMinimum(Arg0, Arg1, Arg2)); }
